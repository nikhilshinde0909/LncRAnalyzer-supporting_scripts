...
write.table(CPPred_Sorghum, 'Final_ROC/CPPred_sorghum.TSV', row.names = F, col.names = T, 
            sep = '\t', quote = F)

write.table(CPPred_Sorghum_metrics, 'Final_ROC/CPPred_sorghum_metrics.TSV', row.names = F, col.names = T, 
            sep = '\t', quote = F)
