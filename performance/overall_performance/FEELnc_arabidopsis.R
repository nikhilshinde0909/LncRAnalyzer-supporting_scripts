...
write.table(FEELnc_arabidopsis, 'Final_ROC/FEELnc_arabidopsis.TSV', row.names = F, col.names = T, 
            sep = '\t', quote = F)

write.table(FEELnc_arabidopsis_metrics, 'Final_ROC/FEELnc_arabidopsis_metrics.TSV', row.names = F, col.names = T, 
            sep = '\t', quote = F)
