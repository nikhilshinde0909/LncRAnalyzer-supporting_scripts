...
write.table(LncFinder_Sorghum, 'Final_ROC/LncFinder_sorghum.TSV', row.names = F, col.names = T, 
            sep = '\t', quote = F)

write.table(LncFinder_Sorghum_metrics, 'Final_ROC/LncFinder_sorghum_metrics.TSV', row.names = F, col.names = T, 
            sep = '\t', quote = F)
