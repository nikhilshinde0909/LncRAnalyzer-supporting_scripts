...
write.table(CPAT_human, 'Final_ROC/CPAT_human.TSV', row.names = F, col.names = T, 
            sep = '\t', quote = F)

write.table(CPAT_human_metrics, 'Final_ROC/CPAT_human_metrics.TSV', row.names = F, col.names = T, 
            sep = '\t', quote = F)
