...
write.table(RNAsamba_fl, 'Final_ROC/RNAsamba_fl.TSV', row.names = F, col.names = T, 
            sep = '\t', quote = F)

write.table(RNAsamba_fl_metrics, 'Final_ROC/RNAsamba_fl_metrics.TSV', row.names = F, col.names = T, 
            sep = '\t', quote = F)
