...
write.table(FEELnc_Sorghum, 'Final_ROC/FEELnc_sorghum.TSV', row.names = F, col.names = T, 
            sep = '\t', quote = F)

write.table(FEELnc_Sorghum_metrics, 'Final_ROC/FEELnc_sorghum_metrics.TSV', row.names = F, col.names = T, 
            sep = '\t', quote = F)
