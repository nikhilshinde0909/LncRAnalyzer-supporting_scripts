...
write.table(CPPred_plants, 'Final_ROC/CPPred_plants.TSV', row.names = F, col.names = T, 
            sep = '\t', quote = F)

write.table(CPPred_plants_metrics, 'Final_ROC/CPPred_plants_metrics.TSV', row.names = F, col.names = T, 
            sep = '\t', quote = F)
