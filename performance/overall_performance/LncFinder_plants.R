...
write.table(LncFinder_plants, 'Final_ROC/LncFinder_plants.TSV', row.names = F, col.names = T, 
            sep = '\t', quote = F)

write.table(LncFinder_plants_metrics, 'Final_ROC/LncFinder_plants_metrics.TSV', row.names = F, col.names = T, 
            sep = '\t', quote = F)
