...
write.table(CPPred_human, 'Final_ROC/CPPred_human.TSV', row.names = F, col.names = T, 
            sep = '\t', quote = F)

write.table(CPPred_human_metrics, 'Final_ROC/CPPred_human_metrics.TSV', row.names = F, col.names = T, 
            sep = '\t', quote = F)
