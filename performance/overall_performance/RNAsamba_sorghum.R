...
write.table(RNAsamba_Sorghum, 'Final_ROC/RNAsamba_sorghum.TSV', row.names = F, col.names = T, 
            sep = '\t', quote = F)

write.table(RNAsamba_Sorghum_metrics, 'Final_ROC/RNAsamba_sorghum_metrics.TSV', row.names = F, col.names = T, 
            sep = '\t', quote = F)
